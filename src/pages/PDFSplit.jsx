...
const projectData = {
  ...
  description: 'Aplicación web diseñada para cargar un compendio de facturas en formato PDF, analizar cada página de forma individual y separar automáticamente cada factura. Al finalizar el proceso, genera un archivo ZIP con todas las facturas organizadas por separado.',
