...
const projectData = {
  ...
  images: [
    ...
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime17.png', alt: 'Captura de Pantalla 6', description: 'Modal para editar factura.' },
    ...
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime7.png', alt: 'Captura de Pantalla 6', description: 'Pantalla principal panel de control.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime8.png', alt: 'Captura de Pantalla 6', description: 'Modal para editar la solicitud.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime9.png', alt: 'Captura de Pantalla 6', description: 'Historial de facturas.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime10.png', alt: 'Captura de Pantalla 6', description: 'Modal informativo para agregar usuarios.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime11.png', alt: 'Captura de Pantalla 6', description: 'Modal informativo de facturas.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime12.png', alt: 'Captura de Pantalla 6', description: 'Pagina para aceptar solicitudes.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime13.png', alt: 'Captura de Pantalla 6', description: 'Mandar solicitua para aprobacion.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime16.png', alt: 'Captura de Pantalla 6', description: 'Historial de solicitudes por usuario.' },
    { src: '/Portafolio/assets/pictures/OvertimeRequest/overtime18.png', alt: 'Captura de Pantalla 6', description: 'Dashboard.' },
  ],
};
